...
from dao.common.utils import load_state_dict_from_checkpoint, log_hyperparameters, PROJECT_ROOT, convert_tensor_to_value
import wandb
...
def run(cfg: DictConfig) -> None:
    ...
    if cfg.get("ckpt_path") is not None and len(cfg.get("ckpt_path")) > 0:
        if cfg.get("load_state_dict_only", False):
            ...
            hydra.utils.log.info(f"Loading model state_dict from {cfg.ckpt_path}")
