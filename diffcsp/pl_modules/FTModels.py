...
# from diffcsp.pl_modules.PTModels_guidance import BaseModule, CrystGenerativePretrainModel, SinusoidalTimeEmbeddings
from diffcsp.pl_modules.PTModels import BaseModule, CrystGenerativePretrainModel, SinusoidalTimeEmbeddings
from diffcsp.common.utils import RequiresGradContext, cal_grad
from diffcsp.pl_modules.diff_utils import d_log_p_wrapped_normal
# from diffcsp.pl_modules.energy_model import IEPModule
...
class CrystGenerativeFinetuneModel(CrystFinetuneModel):
    ...
    def forward(self, batch, mode='train'):
        ...
        pivot = int(self.trainer.max_epochs * 0.6)

##### ================ finetune_E 2stage fix begin ================
...
##### ================ finetune_E 2stage fix end ================
    


####### ============== finetune_E 2stage nofix  begin  ==========
        # if self.current_epoch >= pivot:
        #     energy_0 = batch.y
        #     temperature = 1.
        #     p_label = torch.exp( -energy_0 * temperature)
        ...
        # loss_coord = F.mse_loss(pred_x, tar_x)
        # loss_lattice = F.mse_loss(pred_l, tar_l)
####### ============== finetune_E 2stage nofix  end  ==========


####### ============== finetune_E e2e begin  ==========
