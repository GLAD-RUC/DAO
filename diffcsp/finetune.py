...
os.environ['WANDB_API_KEY'] = 'fddaf47472c08c3319240d801af2d5e1cf2328b6'
...
def run(cfg: DictConfig) -> None:
    ...
    if cfg.train.finetune_mode == 'gen':
        cfg.model._target_ = 'diffcsp.pl_modules.FTModels.CrystGenerativeFinetuneModel'
    elif cfg.train.finetune_mode == 'pred':
        cfg.model._target_ = 'diffcsp.pl_modules.FTModels.CrystPredictiveFinetuneModel'
    # else:
    #     if cfg.train.finetune_mode == 'gen':
    #         cfg.model._target_ = 'diffcsp.pl_modules.SCModels.CrystGenerativeScratchModel'
    #     elif cfg.train.finetune_mode == 'pred':
    #         cfg.model._target_ = 'diffcsp.pl_modules.SCModels.CrystPredictiveScratchModel'
    #     elif cfg.train.finetune_mode == 'lora':
    #         cfg.model._target_ = 'diffcsp.pl_modules.FTModels_Lora.CrystPredictiveFinetuneModel'
